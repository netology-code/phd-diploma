...
9. Заполните спецификацию в разделе «Датчики» в соответствии с подобранными вами датчиками.
10. Аналогично подберите регуляторы и исполнительные механизмы при необходимости.
11. Заполните спецификацию в разделах «Регуляторы» и «Исполнительные механизмы» в соответствии с подобранными вами компонентами.
12. Подберите компоненты электрического шкафа для этой АСУ ТП и заполните спецификацию в разделе «Автоматика».
...
17. Подробнее о работе с Google-документами и загрузке решения на проверку можно найти в [«Руководстве по работе с материалами для обучения»](https://l.netology.ru/instruktsiya-po-materialami-dlya-obucheniya)
18. Вопросы по учебным материалам курса, заданию и логике решений вы можете задать:
