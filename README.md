...
**Обратите внимание!** Если вы планируете выполнять необязательное задание (_*_), то необходимо использовать только TIA Portal v16, если же не планируете - можно воспользоваться любой версией.
<details>
